...
class EarthInfo extends Component {
  ...
  render() {
    return ( 
      ...
      <Text style={{...Font, ...styles.header}}>{bodies.earth.name}</Text>
      <Text style={{...Font, ...styles.headerTwo}}>{bodies.earth.AKA}</Text>
      <Text/>
      <Text style={{...Font, ...styles.basicFacts}}>  Latin: {bodies.earth.latin}    Diameter: {bodies.earth.diameter}       Moons: 1  </Text>
